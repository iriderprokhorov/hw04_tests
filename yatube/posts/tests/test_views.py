...
class PostModelTest(TestCase):
    ...
    def test_follow_author(self):
        ...
        self.assertIn("Custom 404", response_before_follow.content.decode())
        ...
        self.assertIn("Custom 404", response_after_unfollow.content.decode())
    ...
    def test_follow_page(self):
        ...
        self.assertIn("Custom 404", response_before_follow2.content.decode())
        ...
        self.assertIn("Custom 404", response_after_follow3.content.decode())
